...
public class Exercise3 {
    public static void main(String[] args) {
       ArrayList<Account> account = new ArrayList<>();
        ...
        account.add(new Account(card0, "Lionel Messi", 684373));

        Card card1 = new Card("22357", "0011");
        account.add( new Account(card1, "Cristiano Ronaldo", 123145));

        Card card2 = new Card("55335", "1474");
        account.add(new Account(card2, "Ronaldo Nazario", 146632));
